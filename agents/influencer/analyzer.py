...
class ContentAnalyzer(BaseAgent):
    def __init__(self):
        ...
        self.system_prompt = """You are an expert LinkedIn content analyst.
...
2. Content ideas the user can adapt for their audience
...
Return your analysis as valid JSON."""
    ...
    def run(self, scraped_data: list[dict]) -> dict:
        ...
        prompt = (
            ...
            f"content patterns, hook structures, and content ideas to "
            f"adapt for our brand.\n\n"
            ...
            f"- content_ideas: array of 5-10 content ideas for our brand\n"
